...
logging.basicConfig(filename="feature_selection/rnn_features.log", level=logging.INFO,
...
for inx, features in enumerate(FEATURE_COMBINATIONS):
    ...
    lstm_model = RNN(input_size=X_train.shape[1], hidden_size=RNN_HIDDEN_SIZE,
